import { subKeyFinder, textToBinary, binaryToText, groupingTexts, subKey, ip, bitSelect, sbox, p, ipInvers, binaryToHex, hexToBinary } from "./Subkey";
...
export const DecryptMessage = (message, key, selected) => { 
  subKeyFinder(key);
  if (selected === 1) {
