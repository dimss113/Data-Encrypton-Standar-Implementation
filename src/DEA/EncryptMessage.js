...
import { subKeyFinder, textToBinary, binaryToText, groupingTexts, subKey, ip, bitSelect, sbox, p, ipInvers, binaryToHex } from "./Subkey";
...
export const EncryptMessage = (message, key) => { 
  ...
  return [decryptedMessage, binaryToHex(decryptedBinaryMessage)];
}

// testing
// EncryptMessage("UINSUSKA", "156amann");