...
export const ip = [57, 49, 41, 33, 25, 17, 9, 1,
...
export const bitSelect = [31, 0, 1, 2, 3, 4,
                    3, 4, 5, 6, 7, 8,
                    7, 8, 9, 10, 11, 12,
                    11, 12, 13, 14, 15, 16,
                    15, 16, 17, 18, 19, 20,
...
export const p = [15, 6, 19, 20, 28, 11, 27, 16,
...
export const ipInvers = [39, 7, 47, 15, 55, 23, 63, 31,
...
export const pc1 = [56, 48, 40, 32, 24, 16, 8,
            0, 57, 49, 41, 33, 25, 17,
            9, 1, 58, 50, 42, 34, 26,
            18, 10, 2, 59, 51, 43, 35,
...
export const pc2 = [13, 16, 10, 23, 0, 4, 2, 27,
...
export const leftShift = [1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1];

// create variable that store subKey as array with length 16

export let subKey = [];
export let binaryValueKey = "";

export const subKeyFinder = (key) => {
...
export const binaryToText = (binaryString) => {
...
export const groupingTexts = (binary) => {
    let group = [];
